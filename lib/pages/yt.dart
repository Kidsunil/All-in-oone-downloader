...
class YoutubeVideoDownloaderPage extends StatefulWidget {
  const YoutubeVideoDownloaderPage({Key? key}) : super(key: key);

  @override
  State<YoutubeVideoDownloaderPage> createState() =>
      _YoutubeVideoDownloaderPageState();
}

class _YoutubeVideoDownloaderPageState
    extends State<YoutubeVideoDownloaderPage> {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: "Youtube Downloader".text.bold.maxLines(1).make().shimmer(
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                labelText: "Youtube Video/Audio Link",
